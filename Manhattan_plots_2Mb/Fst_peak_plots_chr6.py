...
def fst_manhattan_plot(master_df):
    ...
    chrom_specific_df  = clean_master2[clean_master2['chrom'].isin(['Chromosome_6_RagTag'])]
    window_df_v1 = chrom_specific_df[chrom_specific_df['start'] >= 36500000].copy()
    window_df_v2 = window_df_v1[window_df_v1['end'] <= 38500000].copy()
    ...
    # Add a chrom number column--Chromosome 6
    chrom_num = []
    for i in range(len(start_list)):
        chrom_val = int(6)
    ...
    text_kws=None,
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("1_Fst_belem_xingu_manhattan_Chr6.pdf", format="pdf")
...
def xin_enr_manhattan_plot(master_df):
    ...
    chrom_specific_df  = clean_master2[clean_master2['chrom'].isin(['Chromosome_6_RagTag'])]
    #chrom_specific_df = clean_master3[clean_master3['chrom'].isin(['Chromosome_6_RagTag'])]
    window_df_v1 = chrom_specific_df[chrom_specific_df['start'] >= 36500000].copy()
    window_df_v2 = window_df_v1[window_df_v1['end'] <= 38500000].copy()
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("2_xin_enr_manhattan_Chr6.pdf", format="pdf")
    #return clean_master2
...
def bel_enr_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("3_bel_enr_manhattan_Chr6.pdf", format="pdf")
    #return clean_master2
...
def xin_rth_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("4_xin_RTH_manhattan_Chr6.pdf", format="pdf")
    #return clean_master2
...
def bel_rth_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("5_bel_rth_manhattan_Chr6_fake_final_point.pdf", format="pdf")
    #return clean_master2
...
def xin_bel_rth_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("6_xin_bel_rth_manhattan_Chr6.pdf", format="pdf")
    #return clean_master2
...
def tap_xin_rth_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("7_tap_xin_rth_manhattan_Chr6.pdf", format="pdf")
    #return clean_master2
...
def jcr_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("8_jcr_manhattan_Chr6.pdf", format="pdf")
    #return clean_master2
...
def Q95_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("9_Q95_manhattan_Chr6.pdf", format="pdf")
    #return clean_master2
...
def Dxy_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("10_Dxy_manhattan_Chr6.pdf", format="pdf")
    #return clean_master2
...
def Pi_Xingu_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("11_Pi_Xingu_manhattan_Chr6.pdf", format="pdf")
    #return clean_master2
...
def Pi_Belem_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("12_Pi_Belem_manhattan_Chr6.pdf", format="pdf")
    #return clean_master2
...
def recomb50site_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr6.png", dpi=600)
    plt.savefig("13_recomb50site_manhattan_Chr6.pdf", format="pdf")
    #return clean_master2
