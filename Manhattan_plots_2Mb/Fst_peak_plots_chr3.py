...
def fst_manhattan_plot(master_df):
    ...
    chrom_specific_df  = clean_master2[clean_master2['chrom'].isin(['Chromosome_3_RagTag'])]
    window_df_v1 = chrom_specific_df[chrom_specific_df['start'] >= 35750000].copy()
    window_df_v2 = window_df_v1[window_df_v1['end'] <= 37750000].copy()
    ...
    text_kws=None,
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("1_Fst_belem_xingu_manhattan_Chr3.pdf", format="pdf")
...
def xin_enr_manhattan_plot(master_df):
    ...
    chrom_specific_df  = clean_master2[clean_master2['chrom'].isin(['Chromosome_3_RagTag'])]
    #chrom_specific_df = clean_master3[clean_master3['chrom'].isin(['Chromosome_3_RagTag'])]
    window_df_v1 = chrom_specific_df[chrom_specific_df['start'] >= 35750000].copy()
    window_df_v2 = window_df_v1[window_df_v1['end'] <= 37750000].copy()
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("2_xin_enr_manhattan_Chr3_fake_final_point.pdf", format="pdf")
    #return clean_master2
...
def bel_enr_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("3_bel_enr_manhattan_Chr3.pdf", format="pdf")
    #return clean_master2
...
def xin_rth_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("4_xin_RTH_manhattan_Chr3_fake_final_point.pdf", format="pdf")
    #return clean_master2
...
def bel_rth_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("5_bel_rth_manhattan_Chr3_fake_final_point.pdf", format="pdf")
    #return clean_master2
...
def xin_bel_rth_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("6_xin_bel_rth_manhattan_Chr3.pdf", format="pdf")
    #return clean_master2
...
def tap_xin_rth_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("7_tap_xin_rth_manhattan_Chr3.pdf", format="pdf")
    #return clean_master2
...
def jcr_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("8_jcr_manhattan_Chr3.pdf", format="pdf")
    #return clean_master2
...
def Q95_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("9_Q95_manhattan_Chr3.pdf", format="pdf")
    #return clean_master2
...
def Dxy_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("10_Dxy_manhattan_Chr3.pdf", format="pdf")
    #return clean_master2
...
def Pi_Xingu_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("11_Pi_Xingu_manhattan_Chr3.pdf", format="pdf")
    #return clean_master2
...
def Pi_Belem_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("12_Pi_Belem_manhattan_Chr3.pdf", format="pdf")
    #return clean_master2
...
def recomb50site_manhattan_plot(master_df):
    ...
    ld_block_size=50000)
    #plt.savefig("Fst_belem_xingu_manhattan_Chr3.png", dpi=600)
    plt.savefig("13_recomb50site_manhattan_Chr3.pdf", format="pdf")
    #return clean_master2


def mu_manhattan_plot(master_df):
    print(master_df)
    clean_master = master_df.dropna(subset=['Fst_belem_xingu']).copy()
    clean_master.loc[clean_master['Fst_belem_xingu']<0, 'Fst_belem_xingu']=0
    clean_master2 = clean_master[clean_master['sites_summ_stats'] >= 50].copy() # filtering out windows with fewer than 50 sites
    ...
    percentiles = master_df['mu'].quantile([0.95, 0.96, 0.97, 0.98, 0.99])
    print(f"95th, 96th, 97th, 98th, and 99th percentiles:\n{percentiles}")
    
    # For master_df
    #95th, 96th, 97th, 98th, and 99th percentiles:
    #0.95     6.037171
    #0.96     6.611510
    #0.97     7.518605
    #0.98     9.074186
    ...
    #test = numpy.nanpercentile(master_df['mu'], 99, axis=0)
    #print("test 99th percentile:" + str(test))

    # For proto_master_df (out of 112136 rows)
    #95th, 96th, 97th, 98th, and 99th percentiles:
    #0.95     6.050271
    #0.96     6.627043
    #0.97     7.558776
    ...
    window_df_v2.to_csv('mu_db_df.txt', sep='\t', index=False)
    ...
    text_kws=None,
    ld_block_size=50000)
    #plt.savefig("Mu_belem_manhattan_Chr3.png", dpi=600)
    plt.savefig("14_Mu_belem_manhattan_Chr3.pdf", format="pdf")
    #return clean_master2
...
def main():
    ...
    mu_manhattan_plot(proto_master_df)
